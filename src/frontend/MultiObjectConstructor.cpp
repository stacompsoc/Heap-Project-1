...
void MultiObjectConstructor::Spawn(size_t shape_id, size_t texture_id, gl::Program &program) {
  space->AddObject(
    Object(
...
void MultiObjectConstructor::SpawnPlanet(size_t texture_id, gl::Program &program) {
  Spawn(Storage::SPHERE, texture_id, program);
}

void MultiObjectConstructor::SpawnClouds(size_t texture_id, gl::Program &program) {
